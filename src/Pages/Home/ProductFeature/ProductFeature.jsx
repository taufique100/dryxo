...
const ProductFeature = () => {
  return (
    <div className="container my-0">
      <div className="text-center mb-4 product-img-wrapper">
      ...
      <div className="features-section text-center mb-5">
        <h5 className="mb-4 text-warning">PRODUCT FEATURES</h5>
        <div className="row justify-content-center">
          <div className="col-md-5">
            <ul className="list-unstyled text-start ">
              <li className="lists">🌿 Eco-Friendly: 100% biodegradable and organic materials</li>
              <li className="lists">
                💧 Quick Absorption: Double perforated top sheet for dryness
              </li>
              <li className="lists">🌸 Fresh Fragrance: Keeps you feeling fresh all day</li>
            </ul>
          </div>
          <div className="col-md-5">
            <ul className="list-unstyled text-start">
              ...
              <li className="lists">🪶 Soft Edge Arms: Prevents rashes and irritation</li>
              <li className="lists">🛡️ Leak-Proof Design: Even flow for complete protection</li>
            </ul>
          </div>
        </div>
